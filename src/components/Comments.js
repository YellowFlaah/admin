              ...
              <div className="banner">
                <div className="banner__container">
                  ...
                  <div className="banner__wrap">
                    ...
                    <button className="banner__btn btn btn-light">
                      Mark all as read
                    </button>
                  </div>
                </div>
                  ...
                  <div className="activity__row">
                        ...
                        <div className="activity__inner">
                          <div className="activity__variants">
                            <label className="checkbox">
                              ...
                              <span className="checkbox__in">
                                ...
                                <span className="checkbox__text">Likes</span>
                              </span>
                            </label>
                            <label className="checkbox">
                              <input
                              ...
                              <span className="checkbox__in">
                                <span className="checkbox__tick" />
                                <span className="checkbox__text">Comments</span>
                              </span>
                            </label>
                            <label className="checkbox">
                              <input
                              ...
                              <span className="checkbox__in">
                                <span className="checkbox__tick" />
                                <span className="checkbox__text">Mention</span>
                              </span>
                            </label>
                            <label className="checkbox">
                              <input
                          ...
                          <div className="activity__group">
                              ...
                              <div className="activity__item active">
                                ...
                                <div className="activity__details">
                                  ...
                                  <div className="activity__text">
                                    "Love this so much! What tools do you use to
                                    create your 3d illustrations?"
                                  </div>
                                </div>
                            ...
                            <div className="activity__btns">
                              <button className="activity__btn btn btn-dark">
                                Load More
                              </button>
                            </div>
                          </div>
                    ...
                    <div className="activity__col">
                      ...
                      <div className="editor">
                          ...
                          <div className="editor__body">
                            ...
                            <div className="editor__gallery">
                              ...
                              <div className="editor__preview">
                                <img
                                  className="editor__pic"
                                  src="./assets/img/editor-pic-2.png"
                                  alt=""
                                />
                                <button className="editor__close">
                                  <svg
                        ...
                        <button className="editor__btn btn btn-dark btn_wide">
                          Reply Comment
                        </button>
                      </div>
                    </div>
