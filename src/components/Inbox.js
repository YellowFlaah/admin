                ...
                <div className="inbox">
                  ...
                  <div className="inbox__container">
                    ...
                    <div className="inbox__list">
                      <div className="inbox__item active">
                        ...
                        <div className="inbox__details">
                          ...
                          <div className="inbox__title title">
                          ...
                          <div className="actions">
                            <button className="actions__btn">
                              ...
                              >
                                <path
                                  d="M6.00009 0C2.70009 0 9.15527e-05 2.325 9.15527e-05 5.25C9.15527e-05 8.175 2.70009 10.5 6.00009 10.5C6.30009 10.5 6.60009 10.5 6.82509 10.425L10.5001 12V8.7C11.4001 7.8 12.0001 6.6 12.0001 5.25C12.0001 2.325 9.30009 0 6.00009 0Z"
                                  fill="#1B1D21"
                                />
                    ...
                    <div className="inbox__foot">
                      <button className="inbox__btn btn btn-dark">
                        Load More
                      </button>
                    </div>
                  </div>
                ...
                <div className="inbox">
                  <div className="inbox__control">
                    <div className="inbox__btns">
                      <button className="inbox__btn btn btn-danger">
                        Delete
                      </button>
                      <button className="inbox__btn btn btn-dark">
                        Archive
                    ...
                    <a className="inbox__more" href="#">
                      <svg
                        className="icon icon-dots-border"
                        xmlns="http://www.w3.org/2000/svg"
                        width="24"
                        height="6"
                        viewBox="0 0 24 6"
                      >
                        <path
                          fill="#11142D"
                          d="M11,-1 C12.6568542,-1 14,0.343145751 14,2 C14,3.65685425 12.6568542,5 11,5 C9.34314575,5 8,3.65685425 8,2 C8,0.343145751 9.34314575,-1 11,-1 Z M2,-1 C3.65685425,-1 5,0.343145751 5,2 C5,3.65685425 3.65685425,5 2,5 C0.343145751,5 -1,3.65685425 -1,2 C-1,0.343145751 0.343145751,-1 2,-1 Z M20,-1 C21.6568542,-1 23,0.343145751 23,2 C23,3.65685425 21.6568542,5 20,5 C18.3431458,5 17,3.65685425 17,2 C17,0.343145751 18.3431458,-1 20,-1 Z M11,1 C10.4477153,1 10,1.44771525 10,2 C10,2.55228475 10.4477153,3 11,3 C11.5522847,3 12,2.55228475 12,2 C12,1.44771525 11.5522847,1 11,1 Z M2,1 C1.44771525,1 1,1.44771525 1,2 C1,2.55228475 1.44771525,3 2,3 C2.55228475,3 3,2.55228475 3,2 C3,1.44771525 2.55228475,1 2,1 Z M20,1 C19.4477153,1 19,1.44771525 19,2 C19,2.55228475 19.4477153,3 20,3 C20.5522847,3 21,2.55228475 21,2 C21,1.44771525 20.5522847,1 20,1 Z"
                          transform="translate(1 1)"
                        />
                  ...
                  <div className="inbox__box">
                    ...
                    <div className="inbox__details">
                      ...
                      <div className="inbox__title h5">
                        When is the Sketch version available for download?
                      </div>
                      <div className="inbox__text">
                        <p>
                          Thanks! it's amazing. however, I cannot open this and
                          'cleverly' which was also just released by the same
                          author, on sketch 63.1.
                        </p>
                        <p>
                          I get a message that says that the file cannot be
                          opened. do you have any idea why this might be? can
                          you upload a compatible file with this sketch version
                          please? I'll appreciate the support. thanks in advance
                        </p>
                      </div>
                      <div className="files">
                  ...
                  <div className="editor">
                      ...
                      <div className="editor__head">
                        <div className="editor__control">
                          <button className="editor__action">
                            <svg
                              className="icon icon-editor-smile"
                              width="12"
                              height="12"
                              viewBox="0 0 12 12"
                              fill="none"
                            ...
                            >
                              <path
                                d="M6 9.75C7.275 9.75 8.25 8.775 8.25 7.5H3.75C3.75 8.775 4.725 9.75 6 9.75Z"
                                fill="#808191"
                              />
                              <path
                                fill-rule="evenodd"
                                clip-rule="evenodd"
                                d="M12 3.75C12 3 11.4 2.325 10.65 2.25C9.525 0.825 7.8 0 6 0C4.2 0 2.475 0.825 1.35 2.25C0.6 2.325 0 3 0 3.75V6C0 9.3 2.7 12 6 12C9.3 12 12 9.3 12 6V3.75ZM10.5 4.5V5.25H8.25V3.75H10.5V4.5ZM8.25 2.25H8.475C7.725 1.8 6.9 1.5 6 1.5C5.1 1.5 4.275 1.8 3.525 2.25H3.75C4.575 2.25 5.25 2.925 5.25 3.75H6.75C6.75 2.925 7.425 2.25 8.25 2.25ZM1.5 3.75H3.75V5.25H1.5V3.75ZM1.575 6.75C1.95 8.85 3.75 10.5 6 10.5C8.25 10.5 10.05 8.85 10.425 6.75H8.25C7.425 6.75 6.75 6.075 6.75 5.25H5.25C5.25 6.075 4.575 6.75 3.75 6.75H1.575Z"
                                fill="#808191"
                              />
                          ...
                          <button className="editor__action active">
                            <svg
                              className="icon icon-editor-bold"
                              width="10"
                              height="12"
                              viewBox="0 0 10 12"
                              fill="none"
                          ...
                          <button className="editor__action">
                            <svg
                              className="icon icon-editor-italic"
                              width="6"
                              height="12"
                              viewBox="0 0 6 12"
                              fill="none"
                            ...
                            >
                              <path
                                d="M6 1.5V0H1.5V1.5H2.45299C2.6812 1.5 2.8565 1.70212 2.82422 1.92803L1.69165 9.85607C1.63886 10.2256 1.32242 10.5 0.949185 10.5H0V12H4.5V10.5H3.54701C3.31879 10.5 3.1435 10.2979 3.17577 10.072L4.30835 2.14394C4.36114 1.77445 4.67758 1.5 5.05081 1.5H6Z"
                                fill="#808191"
                              />
                          ...
                          <button className="editor__action">
                            <svg
                              className="icon icon-editor-pic"
                              width="14"
                              height="13"
                              viewBox="0 0 14 13"
                              fill="none"
                            ...
                            >
                              <path
                                fill-rule="evenodd"
                                clip-rule="evenodd"
                                d="M1.75 3.00006H12.25C12.4524 2.98789 12.6503 3.06299 12.7937 3.20637C12.9371 3.34974 13.0122 3.54766 13 3.75006V11.2501C13.0122 11.4525 12.9371 11.6504 12.7937 11.7937C12.6503 11.9371 12.4524 12.0122 12.25 12.0001H1.75C1.5476 12.0122 1.34968 11.9371 1.20631 11.7937C1.06293 11.6504 0.987831 11.4525 0.999997 11.2501V3.75006C0.987831 3.54766 1.06293 3.34974 1.20631 3.20637C1.34968 3.06299 1.5476 2.98789 1.75 3.00006ZM2.5 10.5H11.5V4.5H2.5V10.5Z"
                                fill="#808191"
                              />
                              <rect
                                x="2.5"
                              ...
                              />
                              <path
                                d="M4.75 9.75L8.5 6L10.75 9.75H4.75Z"
                                fill="#808191"
                              />
                              <circle
                                cx="4.75"
                      ...
                      <div className="editor__body">
                        ...
                        <div className="editor__gallery">
                          <div className="editor__preview">
                            <img
                              className="editor__pic"
                              src="./assets/img/editor-pic-1.png"
                              alt=""
                            />
                            <button className="editor__close">
                              <svg
                    ...
                    <button className="editor__btn btn btn-dark">
                      Send Message
                    </button>
                  </div>
                </div>
