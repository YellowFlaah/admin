                ...
                <div className="notification">
                  ...
                  <div className="notification__container">
                        ...
                        <div className="notification__details">
                          ...
                          <div className="actions">
                            ...
                            <button className="actions__btn">
                              ...
                              >
                                <path
                                  d="M10.5 4.5H6V1.5C6 0.6 5.4 0 4.5 0L2.25 5.25H0.75C0.3 5.25 0 5.55 0 6V11.25C0 11.7 0.3 12 0.75 12H9C10.05 12 11.025 11.25 11.175 10.2L11.925 6.3C12.15 5.4 11.475 4.5 10.5 4.5Z"
                                  fill="#1B1D21"
                                />
                              </svg>
                            </button>
                    ...
                    <div className="notification__btns">
                      <button className="notification__btn btn btn-dark">
                        Load More
                      </button>
                    </div>
                  </div>
                    ...
                    <div className="filters__item">
                      ...
                      <div className="filters__variants">
                        ...
                        <label className="checkbox">
                          ...
                          <span className="checkbox__in">
                            <span className="checkbox__tick" />
                            <span className="checkbox__text">Followers</span>
                          </span>
                        </label>
                        <label className="checkbox">
                          <input className="checkbox__input" type="checkbox" />
                      ...
                      <div className="filters__btns">
                        <button className="filters__btn btn btn_purple">
                          Unselect all
                        </button>
                        <button className="filters__btn btn btn_white">
                          Select All
                        </button>
                      </div>
                    </div>
                      ...
                      <div className="filters__line">
                        <label className="radio">
                          ...
                          <span className="radio__in">
                            ...
                            <span className="radio__text">Followers</span>
                          </span>
                        </label>
                        <label className="radio">
                          <input
                          ...
                          <span className="radio__in">
                            <span className="radio__tick" />
                            <span className="radio__text">Everyone</span>
                          </span>
                        </label>
                      </div>
                      <a className="filters__reset" href="#">
                        Reset all filters
                      </a>
                    </div>
                  </div>
